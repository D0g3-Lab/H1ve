...
class DynamicCheckValueChallenge(BaseChallenge):
    ...
    templates = {  # Handlebars templates used for each aspect of challenge editing & viewing
        "create": "/plugins/ctfd-owl/assets/create.html",
        "update": "/plugins/ctfd-owl/assets/update.html",
        "view": "/plugins/ctfd-owl/assets/view.html",
    }
    scripts = {  # Scripts that are loaded when a template is loaded
        "create": "/plugins/ctfd-owl/assets/create.js",
        "update": "/plugins/ctfd-owl/assets/update.js",
        "view": "/plugins/ctfd-owl/assets/view.js",
    }
    # Route at which files are accessible. This must be registered using register_plugin_assets_directory()
    route = "/plugins/ctfd-owl/assets/"
    ...
    def create(request):
        ...
        print(data)
        challenge = DynamicCheckChallenge(**data)
    ...
    def read(challenge):
        ...
        data = {
            ...
            "type": challenge.type,
            "type_data": {
                "id": DynamicCheckValueChallenge.id,
                "name": DynamicCheckValueChallenge.name,
                "templates": DynamicCheckValueChallenge.templates,
                "scripts": DynamicCheckValueChallenge.scripts,
            },
        }
        return data
