...
def load(app):
    ...
    register_plugin_assets_directory(
        app, base_path="/plugins/ctfd_owl/assets/"
    )
    ...
    def admin_list_configs():
        ...
        return render_template('owl_configs.html', configs=configs)
    ...
    def admin_list_containers():
        ...
        return render_template("owl_containers.html", containers=containers, pages=pages, curr_page=page,
